    ...
    <div className="relative min-h-screen w-full">
      ...
      <main className="relative flex min-h-screen items-center justify-center px-4 py-28">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-8 w-full rounded bg-red-600 py-3.5 font-semibold text-white transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-black"
          >
            {isSignIn ? "Log In" : "Sign Up"}
          </button>
